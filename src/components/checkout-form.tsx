...
export function CheckoutForm({ addresses }: { addresses: Address[] }) {
  ...
  async function placeOrder() {
    ...
    if (payment !== "cash_on_delivery") {
      setError("Online payment is not configured yet. Please select Cash on Delivery (COD) or ask the administrator to configure the payment gateway.");
      return;
    }
    setPlacing(true);
    setError("");
